	   ...
	   ButtonPanel.SortButtonListener, MyCanvas.VisualizerProvider
{
	...
	private static final int CAPACITY = 25, FPS = 100;
	...
	private void initialize()
	{
		...
		fpsSlider.setForeground(ColorManager.BAR_BLUE);
		...
		compLabel.setForeground(ColorManager.TEXT);

		// swapping
		swapLabel = new JLabel("Swaps: 0");
		swapLabel.setFont(new Font(null, Font.PLAIN, 15));
		swapLabel.setForeground(ColorManager.TEXT);
