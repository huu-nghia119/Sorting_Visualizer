...
public class Visualizer
{
	...
	{
		if (!hasArray)
			JOptionPane.showMessageDialog(null, "Bạn cần tạo một Array!", "No Array Created Error", JOptionPane.ERROR_MESSAGE);
		return hasArray;
	}
	...
	public void setCapacity(int capacity)
	{
		if(capacity > 1 && capacity <=200) {
			...
			JOptionPane.showMessageDialog(null, "Số lượng phần tử phải lớn hơn 1 và nhỏ hơn hoặc bằng 200! Mời bạn nhập lại", "No Array Created Error", JOptionPane.ERROR_MESSAGE);
